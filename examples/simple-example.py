...
2. Using CLI:
   fastgrpc serve ./simple_example.py:service

3. Using CLI with custom options:
   fastgrpc serve ./simple_example.py:service --service-name Calculator --no-rebuild-protos
"""